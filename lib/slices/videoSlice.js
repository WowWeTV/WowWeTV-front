...
const videoSlice = createSlice({
  ...
  reducers: {
    ...
    modifyComment: (state, { payload }) => {
      state.singleVideo.comments.map((comment) =>
    ...
    removeComment: (state, { payload: id }) => {
      state.singleVideo.comments.filter((comment) => comment.id !== id);
    },
    // addNestedComment: (state, { payload }) => {
    //   return void state.singleVideo.comments.nestedComment.push({
    //     id: faker.random.number(),
